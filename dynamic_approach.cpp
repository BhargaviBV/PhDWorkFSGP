...
int search(string a,int graph)
{
    ...
    string counter;
    counter= s.str();
    string filename="/home/user/Desktop/sem8/programs/sampledata/"+counter+".txt";
...
/*    int k=0;
  ...
  //*************EDGE COUNT****************/
	...
	minsup1=minsup;
        ...
        minsup1=0.2*(batch_size+batch_remove_pointer1) +1;
        //cout<<"\n";
...
////////////////////////////////////////////////////////////////////////////////////////////////
            ...
            //********combinations**/
//no where  frequent singleton edges are stored-ok stored in output
 ofstream f1,g1;
    f1.open("/home/user/Desktop/sem8/programs/dneighbour.txt");
    g1.open("/home/user/Desktop/sem8/programs/dneighbour1.txt");
   ...
   // cout<<"\t----------------Neighbours Information-------------------\n";
    ...
    fi.open("/home/user/Desktop/sem8/programs/dneighbour1.txt");
    string input="";
    ...
    if (fi.is_open())
    {
        ...
        while (getline(fi, input))
        {
            ...
            int x;
            x=search1(count);
           cout<<"Is frequentedge "<<count<<" status:"<<x<<endl;
            if(x==1)
            {
...
//ds(dsMatrix);
    ...
    string line1="";
    opp.open("/home/user/Desktop/sem8/programs/doutput2.txt");
